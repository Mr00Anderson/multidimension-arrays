...
public class Safe7DArray1DLongs {
    private long[] array;
    ...
    public Safe7DArray1DLongs(int dimension1, int dimension2, int dimension3, int dimension4, int dimension5, int dimension6, int dimension7) {
