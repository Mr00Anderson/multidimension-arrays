...
public class Unsafe7DArray1DLongs {
    private long[] array;
    ...
    public Unsafe7DArray1DLongs(int dimension1, int dimension2, int dimension3, int dimension4, int dimension5, int dimension6, int dimension7) {
        ...
        this.array = new long[dimension1 * dimension2 * dimension3 * dimension4 * dimension5 * dimension6 * dimension7];
    }
