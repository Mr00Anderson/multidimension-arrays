...
public class Unsafe7DArray1DBytes {
    private byte[] array;
    ...
    public Unsafe7DArray1DBytes(int dimension1, int dimension2, int dimension3, int dimension4, int dimension5, int dimension6, int dimension7) {
