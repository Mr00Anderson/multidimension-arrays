...
public class Safe9DArray1DTypes<T> {
    private T[] array;
    private int dim1;
    private int dim2;
    private int dim3;
    ...
    public Safe9DArray1DTypes(Class<T> clazz, int dim1, int dim2, int dim3, int dim4, int dim5, int dim6, int dim7, int dim8, int dim9) {
        this.dim1 = dim1;
        this.dim2 = dim2;
        this.dim3 = dim3;
        this.dim4 = dim4;
    ...
    public void set(int i1, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, T value) {
        if (i1 < 0 || i1 >= dim1 || i2 < 0 || i2 >= dim2 || i3 < 0 || i3 >= dim3 ||
            ...
            i7 < 0 || i7 >= dim7 || i8 < 0 || i8 >= dim8 || i9 < 0 || i9 >= dim9) {
