...
public class Unsafe6DArray1DShorts {
    private short[] array;
    private int era;
    private int time;
    private int space;
    ...
    public Unsafe6DArray1DShorts(int era, int time, int space, int depth, int rows, int cols) {
        this.era = era;
        this.time = time;
        this.space = space;
        this.depth = depth;
        this.rows = rows;
        this.cols = cols;
        this.array = new short[era * time * space * depth * rows * cols];
    }

    public void set(int e, int t, int s, int z, int x, int y, short value) {
    ...
    public short get(int e, int t, int s, int z, int x, int y) {
        // No bounds checking here, potentially unsafe
