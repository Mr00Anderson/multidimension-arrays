...
public class Unsafe7DArray1DChar {
    private char[] array;
    ...
    public Unsafe7DArray1DChar(int dimension1, int dimension2, int dimension3, int dimension4, int dimension5, int dimension6, int dimension7) {
        ...
        this.array = new char[dimension1 * dimension2 * dimension3 * dimension4 * dimension5 * dimension6 * dimension7];
    }
