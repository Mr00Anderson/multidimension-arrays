...
public class Unsafe7DArray1DInts {
    private int[] array;
    ...
    public Unsafe7DArray1DInts(int dimension1, int dimension2, int dimension3, int dimension4, int dimension5, int dimension6, int dimension7) {
        ...
        this.array = new int[dimension1 * dimension2 * dimension3 * dimension4 * dimension5 * dimension6 * dimension7];
    }
