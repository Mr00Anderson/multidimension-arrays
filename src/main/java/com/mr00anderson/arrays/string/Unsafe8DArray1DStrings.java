...
public class Unsafe8DArray1DStrings {
    private String[] array;
    private int dim1, dim2, dim3, dim4, dim5, dim6, dim7, dim8;

    public Unsafe8DArray1DStrings(int dim1, int dim2, int dim3, int dim4, int dim5, int dim6, int dim7, int dim8) {
        this.dim1 = dim1;
        this.dim2 = dim2;
        this.dim3 = dim3;
        this.dim4 = dim4;
        ...
        this.dim7 = dim7;
        this.dim8 = dim8;
        this.array = new String[dim1 * dim2 * dim3 * dim4 * dim5 * dim6 * dim7 * dim8];
    }

    public void set(int a, int b, int c, int d, int e, int f, int g, int h, String value) {
