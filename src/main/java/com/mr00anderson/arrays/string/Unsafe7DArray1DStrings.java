...
public class Unsafe7DArray1DStrings {
    ...
    public Unsafe7DArray1DStrings(int dimension1, int dimension2, int dimension3, int dimension4, int dimension5, int dimension6, int dimension7) {
        ...
        this.array = new String[dimension1 * dimension2 * dimension3 * dimension4 * dimension5 * dimension6 * dimension7];
    }
