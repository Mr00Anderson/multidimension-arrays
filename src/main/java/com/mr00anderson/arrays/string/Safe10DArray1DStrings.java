...
public class Safe10DArray1DStrings {
    private String[] array;
    private int dim1, dim2, dim3, dim4, dim5, dim6, dim7, dim8, dim9, dim10;

    public Safe10DArray1DStrings(int dim1, int dim2, int dim3, int dim4, int dim5, int dim6, int dim7, int dim8, int dim9, int dim10) {
        this.dim1 = dim1;
        this.dim2 = dim2;
        this.dim3 = dim3;
        this.dim4 = dim4;
